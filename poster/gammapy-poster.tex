...
\title{Gammapy: a Python Package for Gamma-ray Astronomy} % Poster title

\author[a]{Axel, Donath}
\author[b]{Regis, Terrier}
\author[c]{Atreyee, Sinha}
\author[d]{Luca, Giunti}
\author[a]{Quentin, Remy}
\author[e]{Jose Enrique Ruiz}
\author[f]{Maximilian, Noethe}
\author[g]{Cosimo Nigro}
\author[d]{Fabio Acero}
\author[h]{Fabio Pintore}
\author[b]{Bruno Khelifi}
\author[a]{Laura Oliviera-Nieto}


\institute[a]{Max Planck Institute for Nuclear Physics,\\
  Street number, Heidelberg, Germany}

\institute[b]{APC,\\
  Street number, Paris, France}

\institute[c]{Institution,\\
  Street number, Montpellier, France}

\institute[d]{Institution,\\
  Street number, City, Country}

\institute[e]{Institution,\\
  Street number, Granada, Spain}

\institute[f]{TU Dortmund,\\
  Street number, Dortmund, Germany}

\institute[g]{University, Department,\\
Street number, Barcelona, Spain}

\institute[h]{Institution,\\
  Street number, Palermo, Italy}
%----------------------------------------------------------------------------------------
