...
\footercontent{
  \href{https://www.gammapy.org}{$\gamma \pi$~~Webpage} \hfill
...
\logoright{\includegraphics[height=7cm]{figures/logo/gammapy_logo_white.pdf}}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{CTA Science Tools}
    Gammapy has recently been selected as the package of choice for the
    \coloredhref[pink]{https://www.cta-observatory.org/ctao-adopts-the-gammapy-software-package-for-science-analysis/}{CTA Science Tools}.
